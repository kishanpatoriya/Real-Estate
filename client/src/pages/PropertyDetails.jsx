...
export default function PropertyDetails() {
    ...
    try {
      ...
      if (found) {
        const primaryImg = found.image 
          ? (found.image.startsWith('http') ? found.image : `https://https://real-estate-5-hello.onrender.com${found.image}`)
          : (found.images && found.images.length > 0 ? (found.images[0].startsWith('http') ? found.images[0] : `https://https://real-estate-5-hello.onrender.com${found.images[0]}`) : '');
  ...
  const propertyImages = property.images && property.images.length > 0 
    ? property.images.map(img => img.startsWith('http') ? img : `https://https://real-estate-5-hello.onrender.com${img}`)
